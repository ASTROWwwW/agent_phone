--[[
    Agent Phone media configuration
    ...
    Import = {
        ...
        Websites = {
            ...
            --[[
            {
                ...
                Enabled = true,
                Adapter = "manifest",
                ManifestUrl = "https://media.example.com/agent-phone/media.json",
                MediaTypes = { "photo", "video" },
                AllowedMediaHosts = { "media.example.com", "cdn.example.com" },
                Auth = {
                    Type = "bearer",
                    TokenConvar = "agent_phone_city_media_token",
                },
                RequiredAce = "agent_phone.import.city_media",
            },
            ]]
        },
    },
