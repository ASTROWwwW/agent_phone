Locales["en"] = {
    ...
    TestData = {
        ...
        Success = "Test content is ready. Your Agent Cloud login is {email}. Reopen the phone to refresh every app.",
    ...
    Nui = {
        ...
        Setup = {
            title = "Agent Phone Setup Assistant", ownerFallback = "Agent Phone Owner", getStarted = "Get Started", setUpLater = "Set Up Later",
            development = { skip = "Skip setup" },
            welcome = { title = "Welcome to Agent Phone", eyebrow = "Designed around you", hello = "hello", hallo = "hallo", bonjour = "bonjour", body = "Hello, {name}. Let's make this phone unmistakably yours.", private = "Private by design", personal = "Made for you" },
            connection = {
                eyebrow = "Mobile Connection", title = "Your connection is ready", body = "Agent Phone automatically detects the SIM installed in this device.",
                noSim = "No SIM installed", ready = "Connected to the Agent network", offline = "Phone works offline; calls and messages require a SIM",
                preserved = "Your SIM number and SIM-backed conversations remain with the SIM, even if this phone is erased.",
            },
            cloud = {
                eyebrow = "Agent Cloud", title = "Keep important data with you", body = "Sign in to sync supported app data and recover it on another Agent Phone.",
                signIn = "Sign In", create = "Create Account", email = "Agent Cloud Email", password = "Password", connected = "Agent Cloud connected",
                signInTitle = "Sign in to Agent Cloud", createTitle = "Create your Agent Cloud account",
                ...
                accountPreview = "Your Agent Cloud ID", accountName = "Account name", addressPlaceholder = "alex.morgan", confirmPassword = "Confirm Password",
                ...
                signInAction = "Sign In Securely", createAction = "Create Agent Cloud Account", securityNote = "Encrypted connection · Your password stays private",
                invalid = "Enter a valid email and a password with at least 6 characters.",
                errors = {
                    invalid_email = "Enter a valid Agent Cloud email.", invalid_password = "Your password must contain at least 6 characters.",
                    invalid_credentials = "Email or password is incorrect.", email_taken = "This Agent Cloud email is already registered.",
                    rate_limited = "Too many attempts. Try again shortly.", request_failed = "Agent Cloud is temporarily unavailable.",
                },
            },
            security = {
            ...
            wallpaper = { eyebrow = "Personalize", title = "Make it yours", body = "Choose one of twelve crafted Agent Phone backgrounds." },
            notifications = {
            ...
            apps = {
                ...
                descriptions = { banking = "Secure city banking", garage = "Your vehicles at a glance", agentride = "Request a ride", citymarkt = "Shop local listings", picstagram = "Share photos", snake = "A timeless game" },
            },
            ready = {
                eyebrow = "Setup Complete", title = "Welcome, {name}", body = "Your Agent Phone is configured and ready. Your choices can always be refined in Settings.",
                localOnly = "Stored on this phone", enter = "Enter Agent Phone", review = "Review Setup",
        ...
        Home = {
            ...
            widgets = {
                ...
                battery = { label = "Phone" },
                media = { title = "Night Drive", artist = "Agent Radio", play = "Play", pause = "Pause" },
            },
            widgetSystem = {
        ...
        Apps = {
            ...
            crewlink = {
                ...
                signInTitle = "Connect your Agent Cloud account", signInBody = "CrewLink uses your private Agent Cloud identity to keep groups and roles available across your phones.", openSettings = "Open Agent Cloud settings",
                ...
                authErrors = {
                    no_ifruit_account = "Sign in to your Agent Cloud account in Settings first.", invalid_username = "Use 3-20 letters, numbers, dots, or underscores.", invalid_password = "Password must be 8-72 characters.", invalid_credentials = "The password for this iFruit email is incorrect.",
                ...
                errors = {
                    not_authenticated = "Sign in to your Agent Cloud account first.", profile_required = "Create your CrewLink profile first.", invalid_username = "Use 3-20 letters, numbers, dots, or underscores.", invalid_profile = "Check your profile details.", invalid_profile_image = "Choose a valid photo from this phone.", username_taken = "That CrewLink username is already taken.",
            ...
            flare = {
                name = "Flare", signInTitle = "Sign in to Flare", signInBody = "Flare profiles and matches are linked to your private Agent Cloud account.",
                ...
                accountActions = "Account", signOut = "Sign Out", signOutTitle = "Sign out of Agent Cloud?", signOutBody = "This signs the whole phone out of Agent Cloud. Your Flare profile, matches and chats stay stored.", signingOut = "Signing Out...", signOutHint = "Signing out affects every app that uses Agent Cloud on this phone.",
                deleteAccount = "Delete Flare Account", deleteAccountTitle = "Delete your Flare account?", deleteAccountBody = "Your Flare profile, swipes, matches and conversations will be permanently deleted. Your Agent Cloud account and Photos library stay available.", deletingAccount = "Deleting...",
            ...
            picstagram = {
                ...
                registrationHint = "A Agent Cloud account is required once to create and own a Picstagram profile.",
                ...
                errors = {
                    ...
                    already_registered = "This Agent Cloud account already owns a Picstagram profile.",
                    ...
                    rate_limited = "Too many actions. Try again shortly.", not_authenticated = "Sign in to Agent Cloud first.",
            ...
            feather = {
                ...
                registerNow = "Create a profile", loginNow = "Log in", authTrust = "Your Feather profile is linked to your Agent Cloud account through your iFruit email.",
                profileStep = "Step 2 of 2", accountConnected = "Agent Cloud account connected",
                authErrors = {
                    no_ifruit_account = "Sign in to your Agent Cloud account in Settings first.", invalid_handle = "Use 3-30 letters, numbers or underscores.", invalid_username = "That username does not match your Feather profile.",
                ...
                welcome = "Find your voice", welcomeBody = "Join the live conversation in Los Santos. Your Feather profile stays linked to your Agent Cloud account.",
                ...
                errors = { accountRequired = "Sign in to Agent Cloud in Settings first.", invalidHandle = "Use 3–30 letters, numbers or underscores.", handleTaken = "That handle is already taken.", invalidPost = "Write something or attach a photo.", generic = "Something went wrong. Please try again." },
            ...
            fliptok = {
                ...
                registrationHint = "A Agent Cloud account is required once to create and own a FlipTok profile.",
            ...
            darkchat = {
                ...
                profileActions = "Account Actions", signOut = "Sign Out", signOutTitle = "Sign out of Agent Cloud?", signOutBody = "This signs the whole phone out of Agent Cloud. Your DarkChat profile and messages remain stored.", signingOut = "Signing Out...", signOutHint = "Signing out affects every app that uses Agent Cloud on this phone.", deleteProfile = "Delete DarkChat Profile", deleteProfileTitle = "Delete DarkChat profile?", deleteProfileBody = "Your identity, contacts and DarkChat conversations will be permanently deleted.", deletingProfile = "Deleting...",
            ...
            garage = {
                ...
                valet = {
                    title = "Agent Valet", eyebrow = "Premium delivery",
            ...
            agentride = {
                name = "AgentRide", loading = "Loading AgentRide", unavailable = "AgentRide unavailable", tryAgain = "Try Again",
                ...
                viewRides = "View Ride Options", change = "Change", requestRide = "Request AgentRide", playerDriverNotice = "AgentRide matches you with real player drivers. A driver must be online and accept your request.",
                ...
                profileName = "Name", profileNamePlaceholder = "Your AgentRide name", removeProfilePhoto = "Remove profile photo",
                saveProfile = "Save Profile", profileSaved = "Your AgentRide profile was updated.",
                memberSince = "AgentRide member since {date}", rideComplete = "Ride Complete", rateRide = "Rate your ride",
                ...
                errors = {
                    agentride_unavailable = "AgentRide is currently unavailable.",
                    ...
                    rate_limited = "Please wait a moment before trying again.", request_failed = "AgentRide could not complete the request.",
                    device_not_open = "Open the phone again to use AgentRide.", device_not_owned = "This phone does not belong to this character.",
                    device_locked = "Unlock this phone to use AgentRide.",
                    default = "AgentRide could not complete the request.",
                },
            },
            house = {
            ...
            agentFlappy = {
                name = "Agent Flappy", backToMenu = "Back to game menu", best = "Best", design = "Agent design",
                designs = { dawn = "Dawn", neon = "Neon", storm = "Storm" }, eyebrow = "Agent challenge",
            ...
            calendar = {
                name = "Calendar", today = "Today", calendars = "Calendars", calendar = "Calendar", calendarName = "Agent Cloud",
                ...
                signInTitle = "Your Agent Cloud calendar",
                signInBody = "Sign in to Agent Cloud in Settings to sync appointments and receive reminders.",
                ...
                errors = {
                    ...
                    not_authenticated = "Sign in to your Agent Cloud account first.",
            ...
            citymarkt = {
                ...
                signInTitle = "Sign in to Agent Cloud", signInBody = "Log in to your CityMarkt profile to sell, save or message.",
                ...
                signInToMessage = "Sign in to your Agent Cloud account to send a message.",
                ...
                errors = {
                    ...
                    rate_limited = "Too many requests. Try again shortly.", not_authenticated = "Sign in to your Agent Cloud account first.",
            ...
            localPages = {
                ...
                signInTitle = "Your Local Pages profile", signInBody = "Sign in to Agent Cloud in Settings to publish and save posts.",
                ...
                loginTitle = "Continue with Agent Cloud", loginBody = "Your posts, saved items and profile stay linked to your account.",
                ...
                authErrors = {
                    no_ifruit_account = "Sign in to your Agent Cloud account in Settings first.", invalid_username = "Use 3-24 lowercase letters, numbers, dots or underscores.",
            ...
            appStore = {
                ...
                selected = "Apps available for your Agent Phone",
                ...
                taglines = {
                    ...
                    agentride = "City rides and driver booking", banking = "Accounts, transfers and payments",
                    ...
                    ["tower-stack"] = "Precision tower-building game", ["agent-flappy"] = "Fast arcade flying challenge",
                ...
                previews = {
                    ...
                    agentride = { first = "Ride booking", second = "Driver tracking", third = "Trip history" },
                    ...
                    ["agent-flappy"] = { first = "Flight score", second = "Best run", third = "Obstacles" },
                ...
                account = {
                    account = "Account", title = "App Management", agentAccount = "Agent Phone Account",
                ...
                details = {
                    agentStudios = "Agent Studios", share = "Share app", openDetails = "View {app}",
                    ...
                    crypto = {
                        ...
                        description = "VaultX is Agent Phone's fictional crypto exchange and wallet. Track synthetic markets, manage your character-bound portfolio, deposit or withdraw funds, trade with short-lived server quotes and transfer assets using public VaultX keys. All prices are fictional and have no real-world value.",
                    },
                },
            },
            settings = {
                name = "Settings", searchPlaceholder = "Search", airplaneMode = "Airplane Mode", streamerMode = "Streamer Mode",
                wallpaper = "Wallpaper", on = "On", off = "Off", accountName = "Agent Cloud",
                accountDetail = "Important Data & Cloud", accountLocalDetail = "Not signed in",
                accountCloudDetail = "Important data syncs through Agent Cloud", accountLoginBody = "Sign in to keep your important data safe. Without a Agent Cloud account, it will be lost with the phone.",
                ...
                development = "Development", agentUiKitchenSink = "Agent UI Kitchen Sink",
                agentUiKitchenSinkDescription = "Interactive catalog of first-party Agent UI components",
                about = "About", deviceName = "Device Name", deviceNameValue = "Agent Phone", softwareVersion = "Software Version",
                language = "Language", languageValue = "English", localStorage = "Local Storage", localStorageValue = "On Device",
                back = "Settings", wallpaperPicker = "Agent Wallpapers", deviceInformation = "Device Information",
                ...
                removeDeviceBody = "Enter your Agent Cloud password to remove this device from the account.", signOut = "Sign Out",
                ...
                keepCloudData = "Account & Cloud Data", keepCloudDataBody = "Supported information remains in its app or Agent Cloud account.",
                ...
                factoryResetProgress = "Erasing Agent Phone", factoryResetWarning = "Keep this phone open. Your SIM and cloud data are safe.",
                ...
                passcode = {
                    description = "A passcode protects the contents of this phone. It stays with the device when the SIM or Agent Cloud account changes.",
