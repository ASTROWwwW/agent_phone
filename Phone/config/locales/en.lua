Locales["en"] = {
    ...
    Nui = {
        ...
        Home = {
            ...
            widgets = {
                label = "Widgets",
                edit = "Edit Widgets", empty = "No widgets yet", emptyBody = "Add widgets to keep what matters within reach.",
        ...
        Apps = {
            ...
            picstagram = {
                ...
                registrationHint = "An Agent Cloud account is required once to create and own a Picstagram profile.",
            ...
            fliptok = {
                ...
                registrationHint = "An Agent Cloud account is required once to create and own a FlipTok profile.",
            ...
            banking = {
                ...
                amount = "Amount", recipient = "Recipient", availableBalance = "Available",
                ...
                forms = {
                    transfer = { title = "Send money", submit = "Send transfer" },
                },
                errors = {
            ...
            clock = {
                name = "Clock", lap = "Lap", minutes = "Minutes", add = "Add alarm",
                tabs = { alarm = "Alarm", stopwatch = "Stopwatch", timer = "Timer" },
                alarm = {
            ...
            citymarkt = {
                ...
                signInTitle = "Sign in to Agent Cloud", signInBody = "Log in to your CityMarket profile to sell, save or message.",
                authEyebrow = "CityMarket account", authLoginTitle = "Welcome back", authRegisterTitle = "Create your profile",
                authLoginBody = "Sign in with the iFruit account linked to this phone.",
                authRegisterBody = "Confirm your linked iFruit account to create a CityMarket profile.",
                ...
                authErrors = {
                    ...
                    profile_not_found = "No CityMarket profile exists for this iFruit email.",
                    profile_exists = "A CityMarket profile already exists. Use Sign in instead.",
                    rate_limited = "Too many attempts. Try again in a minute.",
                ...
                createProfile = "Create your CityMarket profile", editProfile = "Edit profile",
                ...
                newMessage = "New CityMarket message from {sender}",
                ...
                errors = {
                    ...
                    invalid_profile_image = "Choose a valid photo from this phone.",
                    profile_required = "Create your CityMarket profile first.",
                    conflict = "The listing changed. Open it again.", request_failed = "CityMarket is temporarily unavailable.",
                    default = "The CityMarket request failed.",
                },
            },
            map = {
            ...
            notes = {
                ...
                groups = { pinned = "Pinned", today = "Today", yesterday = "Yesterday", previous7Days = "Previous 7 Days", previous30Days = "Previous 30 Days", earlier = "Earlier" },
            ...
            appStore = {
                ...
                taglines = {
                    ...
                    ["agent-flappy"] = "Fast arcade flying challenge",
            ...
            settings = {
                ...
                accountCloudDetail = "Important data syncs through Agent Cloud", accountLoginBody = "Sign in to keep your important data safe. Without an Agent Cloud account, it will be lost with the phone.",
                ...
                about = "About", phoneOwner = "Phone Owner", occupation = "Occupation", deviceName = "Device Name", deviceNameValue = "Agent Phone", softwareVersion = "Software Version",
