...
function AgentPhoneYouTube.ParseId(value)
...
function AgentPhoneYouTube.WatchUrl(video_id)
    return "https://www.youtube.com/watch?v=" .. video_id
end

function AgentPhoneYouTube.FetchMetadata(video_id)
    ...
    PerformHttpRequest(
        "https://www.youtube.com/oembed?format=json&url=" .. AgentPhoneYouTube.WatchUrl(video_id),
