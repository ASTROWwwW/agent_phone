local legacy_accounts = Bridge.Database.Query([[
    ...
    WHERE TABLE_SCHEMA = DATABASE()
        AND TABLE_NAME IN ('agent_phone_mail_accounts', 'agent_phone_accounts')
]], {})
...
local schema = {
    {
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_mail_email", columns = "(`email`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_mail_messages",
        columns = {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_mail_sender", columns = "(`sender_account_id`, `created_at`)" },
        },
        foreignKeys = {
            {
                column = "sender_account_id",
                references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE",
            },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_mailboxes",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_mailbox_name", columns = "(`account_id`, `name`)" },
        },
        indexes = {
            { name = "idx_agent_phone_mailboxes", columns = "(`account_id`, `sort_order`, `id`)" },
        },
        foreignKeys = {
            {
                column = "account_id",
    ...
    },
    {
        ...
        uniqueKeys = {
            {
                name = "uniq_agent_phone_mail_entry",
                columns = "(`message_id`, `account_id`, `folder`)",
            },
        },
        indexes = {
            { name = "idx_agent_phone_mailbox", columns = "(`account_id`, `folder`, `trashed_at`, `id`)" },
            { name = "idx_agent_phone_custom_mailbox", columns = "(`account_id`, `mailbox_id`, `trashed_at`, `id`)" },
        },
        foreignKeys = {
            {
                column = "message_id",
                references = "`agent_phone_mail_messages` (`id`) ON DELETE CASCADE",
            },
            {
                column = "account_id",
                references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE",
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_mail_drafts", columns = "(`account_id`, `updated_at`)" },
        },
        foreignKeys = {
            {
                column = "account_id",
    ...
    },
    {
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_sim_number", columns = "(`phone_number`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_devices",
        columns = {
            {
                name = "imei",
        ...
        primaryKey = "imei",
        uniqueKeys = {
            { name = "uniq_agent_phone_devices_sim", columns = "(`sim_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_devices_account", columns = "(`account_id`, `updated_at`)" },
        },
        foreignKeys = {
            {
                column = "account_id",
                references = "`agent_phone_accounts` (`id`) ON DELETE SET NULL",
            },
            {
                column = "sim_id",
                references = "`agent_phone_sims` (`id`) ON DELETE SET NULL",
            },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_character_devices",
        columns = {
            {
        ...
        uniqueKeys = {
            { name = "uniq_agent_phone_character_devices_device", columns = "(`device_imei`)" },
        },
        foreignKeys = {
            {
                column = "device_imei",
                references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE",
            },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_migrations",
        columns = {
        ...
        primaryKey = "name",
        indexes = {
            { name = "idx_agent_phone_migrations_source", columns = "(`source`, `completed_at`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_migration_numbers",
        columns = {
            { name = "source", type = "VARCHAR(32) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        uniqueKeys = {
            { name = "uniq_agent_phone_migration_number", columns = "(`source`, `phone_number`)" },
        },
        indexes = {
            { name = "idx_agent_phone_migration_numbers_sim", columns = "(`sim_id`)" },
        },
        foreignKeys = {
            { column = "sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_migration_owners",
        columns = {
            { name = "source", type = "VARCHAR(32) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        uniqueKeys = {
            { name = "uniq_agent_phone_migration_owner_number", columns = "(`source`, `source_phone_number`)" },
        },
        indexes = {
            { name = "idx_agent_phone_migration_owner", columns = "(`source`, `owner_identifier`)" },
            { name = "idx_agent_phone_migration_owner_device", columns = "(`device_imei`)" },
            { name = "idx_agent_phone_migration_owner_account", columns = "(`account_id`)" },
        },
        foreignKeys = {
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
            { column = "sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_device_data",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            {
                name = "device_imei",
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_device_namespace", columns = "(`device_imei`, `namespace`)" },
        },
        foreignKeys = {
            {
                column = "device_imei",
    ...
    {
        name = "agent_phone_custom_app_data",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            {
                name = "device_imei",
        ...
        uniqueKeys = {
            {
                name = "uniq_agent_phone_custom_app_data",
                columns = "(`device_imei`, `app_id`, `data_key`)",
            },
        },
        indexes = {
            {
                name = "idx_agent_phone_custom_app_storage",
    ...
    {
        name = "agent_phone_device_security",
        columns = {
            {
                name = "device_imei",
                type = "CHAR(15) NOT NULL",
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_admin_audit_created", columns = "(`created_at`, `id`)" },
            { name = "idx_agent_phone_admin_audit_target", columns = "(`target_identifier`, `created_at`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_notes",
        columns = {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_notes_account", columns = "(`account_id`, `updated_at`)" },
            { name = "idx_agent_phone_notes_device", columns = "(`device_imei`, `updated_at`)" },
        },
        foreignKeys = {
            {
                column = "account_id",
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_media_account", columns = "(`account_id`, `created_at`, `id`)" },
            { name = "idx_agent_phone_media_device", columns = "(`device_imei`, `created_at`, `id`)" },
        },
        foreignKeys = {
            {
                column = "account_id",
    ...
    },
    {
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_voice_memos_media", columns = "(`media_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_voice_memos_list", columns = "(`pinned`, `updated_at`, `id`)" },
        },
        foreignKeys = {
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_contacts_account", columns = "(`account_id`, `name`)" },
            { name = "idx_agent_phone_contacts_device", columns = "(`device_imei`, `name`)" },
            { name = "idx_agent_phone_contacts_avatar", columns = "(`avatar_media_id`)" },
        },
        foreignKeys = {
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_calls_caller", columns = "(`caller_sim_id`, `started_at`)" },
            { name = "idx_agent_phone_calls_callee", columns = "(`callee_sim_id`, `started_at`)" },
        },
        foreignKeys = {
            { column = "caller_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
            { column = "callee_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_call_blocks",
        columns = {
            {
                name = "blocker_sim_id",
        ...
        indexes = {
            { name = "idx_agent_phone_call_blocks_blocked", columns = "(`blocked_sim_id`)" },
        },
        foreignKeys = {
            { column = "blocker_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
            { column = "blocked_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_call_entries",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_call_entries_account", columns = "(`account_id`, `created_at`)" },
            { name = "idx_agent_phone_call_entries_device", columns = "(`device_imei`, `created_at`)" },
        },
        foreignKeys = {
            { column = "call_id", references = "`agent_phone_calls` (`id`) ON DELETE CASCADE" },
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    ...
    {
        name = "agent_phone_bank_transactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_bank_owner", columns = "(`owner_identifier`, `id`)" },
            { name = "idx_agent_phone_bank_reference", columns = "(`reference`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_billing_recipient", columns = "(`recipient_identifier`, `status`, `due_at`, `id`)" },
            { name = "idx_agent_phone_billing_issuer", columns = "(`issuer_identifier`, `status`, `id`)" },
            { name = "idx_agent_phone_billing_unread", columns = "(`recipient_identifier`, `read_at`)" },
            { name = "idx_agent_phone_billing_account", columns = "(`issuer_account`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_billing_payments",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = { { name = "idx_agent_phone_billing_payment_invoice", columns = "(`invoice_id`, `id`)" } },
        foreignKeys = { { column = "invoice_id", references = "`agent_phone_billing_invoices` (`id`) ON DELETE CASCADE" } },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_billing_events",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "invoice_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = { { name = "idx_agent_phone_billing_event_invoice", columns = "(`invoice_id`, `id`)" } },
        foreignKeys = { { column = "invoice_id", references = "`agent_phone_billing_invoices` (`id`) ON DELETE CASCADE" } },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_billing_accounts",
        columns = {
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_sms_sender", columns = "(`sender_sim_id`, `created_at`)" },
            { name = "idx_agent_phone_sms_recipient", columns = "(`recipient_sim_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "sender_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE SET NULL" },
            { column = "recipient_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_profiles",
        columns = {
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        indexes = {
            { name = "idx_agent_phone_marketplace_profile_avatar", columns = "(`avatar_media_id`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "avatar_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
    ...
    {
        name = "agent_phone_marketplace_listings",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_marketplace_feed", columns = "(`status`, `created_at`)" },
            { name = "idx_agent_phone_marketplace_category", columns = "(`category`, `status`, `created_at`)" },
            { name = "idx_agent_phone_marketplace_seller", columns = "(`seller_account_id`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "seller_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "reserved_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_images",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_marketplace_image_order", columns = "(`listing_id`, `sort_order`)" },
        },
        foreignKeys = {
            { column = "listing_id", references = "`agent_phone_marketplace_listings` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_favorites",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "listing_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_marketplace_favorite", columns = "(`account_id`, `listing_id`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "listing_id", references = "`agent_phone_marketplace_listings` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_marketplace_inquiries",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "listing_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "seller_account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_marketplace_inquiry", columns = "(`listing_id`, `buyer_account_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_marketplace_inquiry_seller", columns = "(`seller_account_id`, `updated_at`)" },
            { name = "idx_agent_phone_marketplace_inquiry_buyer", columns = "(`buyer_account_id`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "listing_id", references = "`agent_phone_marketplace_listings` (`id`) ON DELETE CASCADE" },
            { column = "seller_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "buyer_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_messages",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_marketplace_messages", columns = "(`inquiry_id`, `id`)" },
            { name = "idx_agent_phone_marketplace_unread", columns = "(`inquiry_id`, `read_at`, `sender_account_id`)" },
        },
        foreignKeys = {
            { column = "inquiry_id", references = "`agent_phone_marketplace_inquiries` (`id`) ON DELETE CASCADE" },
            { column = "sender_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_offers",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "inquiry_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_marketplace_offers", columns = "(`inquiry_id`, `id`)" },
            { name = "idx_agent_phone_marketplace_offer_unread", columns = "(`inquiry_id`, `read_at`, `proposer_account_id`)" },
            { name = "idx_agent_phone_marketplace_offer_response_unread", columns = "(`inquiry_id`, `response_read_at`, `proposer_account_id`)" },
        },
        foreignKeys = {
            { column = "inquiry_id", references = "`agent_phone_marketplace_inquiries` (`id`) ON DELETE CASCADE" },
            { column = "proposer_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_blocks",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_marketplace_block", columns = "(`blocker_account_id`, `blocked_account_id`)" },
        },
        foreignKeys = {
            { column = "blocker_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "blocked_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_marketplace_reports",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_marketplace_report", columns = "(`reporter_account_id`, `listing_id`)" },
        },
        foreignKeys = {
            { column = "reporter_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "listing_id", references = "`agent_phone_marketplace_listings` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    ...
    },
    {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_map_markers_device", columns = "(`device_imei`, `created_at`)" },
        },
        foreignKeys = {
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_calendar_events",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "title", type = "VARCHAR(120) NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_calendar_account", columns = "(`account_id`, `starts_at`)" },
            { name = "idx_agent_phone_calendar_reminders", columns = "(`reminded_at`, `starts_at`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_music_youtube_songs",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "account_id", type = "BIGINT UNSIGNED NULL" },
            { name = "device_imei", type = "CHAR(15) NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_music_youtube_account", columns = "(`account_id`, `video_id`)" },
            { name = "uniq_agent_phone_music_youtube_device", columns = "(`device_imei`, `video_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_music_youtube_account", columns = "(`account_id`, `created_at`)" },
            { name = "idx_agent_phone_music_youtube_device", columns = "(`device_imei`, `created_at`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_music_playlists",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "account_id", type = "BIGINT UNSIGNED NULL" },
            { name = "device_imei", type = "CHAR(15) NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_music_playlists_account", columns = "(`account_id`, `updated_at`)" },
            { name = "idx_agent_phone_music_playlists_device", columns = "(`device_imei`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_music_playlist_items",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_music_playlist_song", columns = "(`playlist_id`, `source`, `song_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_music_playlist_order", columns = "(`playlist_id`, `position`, `id`)" },
        },
        foreignKeys = {
    ...
    {
        name = "agent_phone_darkchat_profiles",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_darkchat_profile_account", columns = "(`account_id`)" },
            { name = "uniq_agent_phone_darkchat_profile_dark_id", columns = "(`dark_id`)" },
            { name = "uniq_agent_phone_darkchat_profile_invite", columns = "(`invite_code`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_darkchat_contacts",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_darkchat_contact", columns = "(`profile_id`, `contact_profile_id`)" },
        },
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
            { column = "contact_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_darkchat_conversations",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_darkchat_conversation_updated", columns = "(`updated_at`)" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_darkchat_members",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_darkchat_member", columns = "(`conversation_id`, `profile_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_darkchat_member_profile", columns = "(`profile_id`, `conversation_id`)" },
        },
        foreignKeys = {
            { column = "conversation_id", references = "`agent_phone_darkchat_conversations` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_darkchat_messages",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "conversation_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_darkchat_message_thread", columns = "(`conversation_id`, `created_at`, `id`)" },
            { name = "idx_agent_phone_darkchat_message_expiry", columns = "(`expires_at`)" },
        },
        foreignKeys = {
            { column = "conversation_id", references = "`agent_phone_darkchat_conversations` (`id`) ON DELETE CASCADE" },
            { column = "sender_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_darkchat_blocks",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_darkchat_block", columns = "(`blocker_profile_id`, `blocked_profile_id`)" },
        },
        foreignKeys = {
            { column = "blocker_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
            { column = "blocked_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_darkchat_reports",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_darkchat_report_target", columns = "(`reported_profile_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "reporter_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
            { column = "reported_profile_id", references = "`agent_phone_darkchat_profiles` (`id`) ON DELETE CASCADE" },
            { column = "conversation_id", references = "`agent_phone_darkchat_conversations` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_profiles",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_account", columns = "(`account_id`)" },
            { name = "uniq_agent_phone_picstagram_handle", columns = "(`handle`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "avatar_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
    ...
    {
        name = "agent_phone_picstagram_credentials",
        columns = {
        ...
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_sessions",
        columns = {
            { name = "device_imei", type = "CHAR(15) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "created_at", type = "DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP" },
        ...
        primaryKey = "device_imei",
        indexes = {
            { name = "idx_agent_phone_picstagram_sessions_profile", columns = "(`profile_id`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_picstagram_posts",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_picstagram_feed", columns = "(`status`, `created_at`, `id`)" },
            { name = "idx_agent_phone_picstagram_profile_posts", columns = "(`profile_id`, `status`, `created_at`)" },
        },
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_picstagram_post_media",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_post_position", columns = "(`post_id`, `position`)" },
            { name = "uniq_agent_phone_picstagram_post_media", columns = "(`post_id`, `media_id`)" },
        },
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_picstagram_posts` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_reactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_reaction", columns = "(`post_id`, `profile_id`, `kind`)" },
        },
        indexes = {
            { name = "idx_agent_phone_picstagram_saved", columns = "(`profile_id`, `kind`, `created_at`)" },
        },
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_picstagram_posts` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_picstagram_follows",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_follow", columns = "(`follower_id`, `following_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_picstagram_following", columns = "(`following_id`, `status`, `created_at`)" },
        },
        foreignKeys = {
            { column = "follower_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "following_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_comments",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_picstagram_comments", columns = "(`post_id`, `status`, `created_at`)" },
        },
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_picstagram_posts` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "parent_id", references = "`agent_phone_picstagram_comments` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_comment_reactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_comment_reaction", columns = "(`comment_id`, `profile_id`)" },
        },
        foreignKeys = {
            { column = "comment_id", references = "`agent_phone_picstagram_comments` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_stories",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_picstagram_stories", columns = "(`profile_id`, `status`, `expires_at`)" },
            { name = "idx_agent_phone_picstagram_story_expiry", columns = "(`status`, `expires_at`)" },
        },
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_picstagram_story_views",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_story_view", columns = "(`story_id`, `profile_id`)" },
        },
        foreignKeys = {
            { column = "story_id", references = "`agent_phone_picstagram_stories` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_activities",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_picstagram_activity", columns = "(`recipient_id`, `read_at`, `created_at`)" },
        },
        foreignKeys = {
            { column = "recipient_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "actor_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "post_id", references = "`agent_phone_picstagram_posts` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_reports",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_report", columns = "(`reporter_id`, `target_type`, `target_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_picstagram_reports", columns = "(`status`, `created_at`)" },
        },
        foreignKeys = {
            { column = "reporter_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_blocks",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_picstagram_block", columns = "(`blocker_id`, `blocked_id`)" },
        },
        foreignKeys = {
            { column = "blocker_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
            { column = "blocked_id", references = "`agent_phone_picstagram_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_picstagram_moderation_audit",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_picstagram_audit_target", columns = "(`target_type`, `target_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "report_id", references = "`agent_phone_picstagram_reports` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_profiles",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "handle", type = "VARCHAR(24) NOT NULL", characterSet = "ascii", collation = "ascii_general_ci" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_fliptok_account", columns = "(`account_id`)" },
            { name = "uniq_agent_phone_fliptok_handle", columns = "(`handle`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "avatar_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
    ...
    {
        name = "agent_phone_fliptok_credentials",
        columns = {
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "password_hash", type = "BINARY(32) NOT NULL" },
            { name = "password_salt", type = "CHAR(32) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "profile_id",
        foreignKeys = {{ column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" }},
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_sessions",
        columns = {
            { name = "device_imei", type = "CHAR(15) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "created_at", type = "DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP" },
        ...
        primaryKey = "device_imei",
        indexes = {{ name = "idx_agent_phone_fliptok_sessions_profile", columns = "(`profile_id`, `updated_at`)" }},
        foreignKeys = {
            { column = "device_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_videos",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_fliptok_feed", columns = "(`status`, `visibility`, `created_at`)" },
            { name = "idx_agent_phone_fliptok_profile", columns = "(`profile_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_fliptok_video_media",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_fliptok_video_media_order", columns = "(`video_id`, `sort_order`)" },
            { name = "uniq_agent_phone_fliptok_video_media", columns = "(`video_id`, `media_id`)" },
        },
        foreignKeys = {
            { column = "video_id", references = "`agent_phone_fliptok_videos` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_reactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "video_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_fliptok_reaction", columns = "(`video_id`, `profile_id`, `kind`)" }},
        foreignKeys = {
            { column = "video_id", references = "`agent_phone_fliptok_videos` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_fliptok_follows",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_fliptok_follow", columns = "(`follower_id`, `following_id`)" }},
        foreignKeys = {
            { column = "follower_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "following_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_comments",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "video_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_fliptok_comments", columns = "(`video_id`, `created_at`)" },
            { name = "idx_agent_phone_fliptok_comment_parent", columns = "(`parent_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "video_id", references = "`agent_phone_fliptok_videos` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "parent_id", references = "`agent_phone_fliptok_comments` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_comment_reactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "comment_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_fliptok_comment_reaction", columns = "(`comment_id`, `profile_id`)" },
        },
        foreignKeys = {
            { column = "comment_id", references = "`agent_phone_fliptok_comments` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_notifications",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {{ name = "idx_agent_phone_fliptok_activity", columns = "(`recipient_id`, `created_at`)" }},
        foreignKeys = {
            { column = "recipient_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "actor_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "video_id", references = "`agent_phone_fliptok_videos` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_reports",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_fliptok_report", columns = "(`reporter_id`, `video_id`)" }},
        foreignKeys = {
            { column = "reporter_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "video_id", references = "`agent_phone_fliptok_videos` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_fliptok_blocks",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_fliptok_block", columns = "(`blocker_id`, `blocked_id`)" }},
        foreignKeys = {
            { column = "blocker_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
            { column = "blocked_id", references = "`agent_phone_fliptok_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_flare_profiles",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_flare_profile_account", columns = "(`account_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_flare_discovery", columns = "(`gender`, `age`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_flare_profile_photos",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_flare_photo_order", columns = "(`profile_id`, `sort_order`)" },
            { name = "uniq_agent_phone_flare_photo_media", columns = "(`profile_id`, `media_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_flare_photo_media", columns = "(`media_id`)" },
        },
        foreignKeys = {
            {
                column = "profile_id",
                references = "`agent_phone_flare_profiles` (`id`) ON DELETE CASCADE",
            },
            {
                column = "media_id",
                references = "`agent_phone_media` (`id`) ON DELETE CASCADE",
            },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_flare_swipes",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_flare_swipe", columns = "(`swiper_account_id`, `target_account_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_flare_swipe_target", columns = "(`target_account_id`, `choice`)" },
        },
        foreignKeys = {
            { column = "swiper_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "target_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_flare_matches",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_flare_match_pair", columns = "(`account_a_id`, `account_b_id`)" },
        },
        indexes = {
            { name = "idx_agent_phone_flare_match_b", columns = "(`account_b_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "account_a_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "account_b_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_flare_messages",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_flare_message_thread", columns = "(`match_id`, `created_at`, `id`)" },
            { name = "idx_agent_phone_flare_message_unread", columns = "(`match_id`, `sender_account_id`, `read_at`)" },
        },
        foreignKeys = {
            { column = "match_id", references = "`agent_phone_flare_matches` (`id`) ON DELETE CASCADE" },
            { column = "sender_account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_agentride_profiles",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            {
                name = "owner_identifier",
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_agentride_owner", columns = "(`owner_identifier`)" },
        },
        indexes = {
            { name = "idx_agent_phone_agentride_profile_avatar", columns = "(`avatar_media_id`)" },
        },
        foreignKeys = {
            { column = "avatar_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
        },
    ...
    {
        name = "agent_phone_feather_profiles",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "account_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_feather_account", columns = "(`account_id`)" },
            { name = "uniq_agent_phone_feather_handle", columns = "(`handle`)" },
        },
        foreignKeys = {
            { column = "account_id", references = "`agent_phone_accounts` (`id`) ON DELETE CASCADE" },
            { column = "avatar_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
    ...
    {
        name = "agent_phone_agentride_rides",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            {
        ...
        indexes = {
            {
                name = "idx_agent_phone_agentride_passenger",
                columns = "(`passenger_profile_id`, `status`, `updated_at`)",
            },
            {
                name = "idx_agent_phone_agentride_driver",
                columns = "(`driver_profile_id`, `status`, `updated_at`)",
            },
            { name = "idx_agent_phone_agentride_requests", columns = "(`status`, `created_at`)" },
            {
                name = "idx_agent_phone_agentride_refunds",
        ...
        foreignKeys = {
            {
                ...
                references = "`agent_phone_agentride_profiles` (`id`) ON DELETE CASCADE",
            },
            {
                column = "driver_profile_id",
                references = "`agent_phone_agentride_profiles` (`id`) ON DELETE SET NULL",
            },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_posts",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_feather_feed", columns = "(`status`, `created_at`)" },
            { name = "idx_agent_phone_feather_profile", columns = "(`profile_id`, `created_at`)" },
            { name = "idx_agent_phone_feather_replies", columns = "(`reply_to_id`, `created_at`)" },
        },
        foreignKeys = {
            { column = "profile_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "reply_to_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE SET NULL" },
            { column = "quote_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_hashtags",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_feather_hashtag", columns = "(`post_id`, `tag`)" }},
        indexes = {{ name = "idx_agent_phone_feather_hashtag_rank", columns = "(`tag`, `post_id`)" }},
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_post_media",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_feather_media_order", columns = "(`post_id`, `sort_order`)" },
            { name = "uniq_agent_phone_feather_media", columns = "(`post_id`, `media_id`)" },
        },
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_feather_reactions",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "profile_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_feather_reaction", columns = "(`post_id`, `profile_id`, `kind`)" }},
        foreignKeys = {
            { column = "post_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE CASCADE" },
            { column = "profile_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_feather_follows",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "follower_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "following_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_feather_follow", columns = "(`follower_id`, `following_id`)" }},
        foreignKeys = {
            { column = "follower_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "following_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_notifications",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "recipient_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "actor_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {{ name = "idx_agent_phone_feather_activity", columns = "(`recipient_id`, `created_at`)" }},
        foreignKeys = {
            { column = "recipient_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "actor_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "post_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_blocks",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "blocker_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "blocked_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_feather_block", columns = "(`blocker_id`, `blocked_id`)" }},
        foreignKeys = {
            { column = "blocker_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "blocked_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_feather_reports",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "reporter_id", type = "BIGINT UNSIGNED NOT NULL" },
            { name = "post_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {{ name = "uniq_agent_phone_feather_report", columns = "(`reporter_id`, `post_id`)" }},
        foreignKeys = {
            { column = "reporter_id", references = "`agent_phone_feather_profiles` (`id`) ON DELETE CASCADE" },
            { column = "post_id", references = "`agent_phone_feather_posts` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    ...
    {
        name = "agent_phone_company_profiles",
        columns = {
        ...
        indexes = {
            { name = "idx_agent_phone_company_profiles_public", columns = "(`availability`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "logo_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
            { column = "cover_media_id", references = "`agent_phone_media` (`id`) ON DELETE SET NULL" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_easyshare_transfers",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_easyshare_sender", columns = "(`sender_imei`, `created_at`)" },
            { name = "idx_agent_phone_easyshare_recipient", columns = "(`recipient_imei`, `created_at`)" },
        },
        foreignKeys = {
            { column = "sender_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
            { column = "recipient_imei", references = "`agent_phone_devices` (`imei`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_company_hours",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "company_id", type = "VARCHAR(64) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_company_hours_day", columns = "(`company_id`, `weekday`)" },
        },
        foreignKeys = {
            { column = "company_id", references = "`agent_phone_company_profiles` (`company_id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_company_services",
        columns = {
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_services_list", columns = "(`company_id`, `archived`, `active`, `sort_order`)" },
        },
        foreignKeys = {
            { column = "company_id", references = "`agent_phone_company_profiles` (`company_id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_company_announcements",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "company_id", type = "VARCHAR(64) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "title", type = "VARCHAR(120) NOT NULL" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_announcements_active", columns = "(`company_id`, `active`, `expires_at`, `created_at`)" },
        },
        foreignKeys = {
            { column = "company_id", references = "`agent_phone_company_profiles` (`company_id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_company_requests",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "company_id", type = "VARCHAR(64) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_requests_customer", columns = "(`customer_sim_id`, `updated_at`, `id`)" },
            { name = "idx_agent_phone_company_requests_queue", columns = "(`company_id`, `status`, `updated_at`, `id`)" },
            { name = "idx_agent_phone_company_requests_assignee", columns = "(`company_id`, `assigned_identifier`, `status`)" },
            { name = "idx_agent_phone_company_requests_service_line", columns = "(`company_id`, `customer_sim_id`, `channel`, `status`, `updated_at`, `id`)" },
        },
        foreignKeys = {
            { column = "company_id", references = "`agent_phone_company_profiles` (`company_id`) ON DELETE CASCADE" },
            { column = "service_id", references = "`agent_phone_company_services` (`id`) ON DELETE SET NULL" },
            { column = "customer_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_company_request_reads",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_company_request_reads_reader", columns = "(`request_id`, `reader_identifier`)" },
        },
        indexes = {
            { name = "idx_agent_phone_company_request_reads_identifier", columns = "(`reader_identifier`, `updated_at`)" },
        },
        foreignKeys = {
            { column = "request_id", references = "`agent_phone_company_requests` (`id`) ON DELETE CASCADE" },
        },
        tableOptions = "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
    },
    {
        name = "agent_phone_company_request_media",
        columns = {
            { name = "id", type = "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT" },
            { name = "request_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "media_id", type = "BIGINT UNSIGNED NOT NULL" },
        ...
        primaryKey = "id",
        uniqueKeys = {
            { name = "uniq_agent_phone_company_request_media", columns = "(`request_id`, `media_id`)" },
            { name = "uniq_agent_phone_company_request_media_order", columns = "(`request_id`, `sort_order`)" },
        },
        foreignKeys = {
            { column = "request_id", references = "`agent_phone_company_requests` (`id`) ON DELETE CASCADE" },
            { column = "media_id", references = "`agent_phone_media` (`id`) ON DELETE CASCADE" },
    ...
    {
        name = "agent_phone_company_request_messages",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "request_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_request_messages", columns = "(`request_id`, `created_at`, `id`)" },
        },
        foreignKeys = {
            { column = "request_id", references = "`agent_phone_company_requests` (`id`) ON DELETE CASCADE" },
            { column = "sender_sim_id", references = "`agent_phone_sims` (`id`) ON DELETE SET NULL" },
    ...
    {
        name = "agent_phone_company_request_events",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "request_id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_request_events", columns = "(`request_id`, `created_at`, `id`)" },
        },
        foreignKeys = {
            { column = "request_id", references = "`agent_phone_company_requests` (`id`) ON DELETE CASCADE" },
        },
    ...
    {
        name = "agent_phone_company_audit",
        columns = {
            { name = "id", type = "CHAR(36) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
            { name = "company_id", type = "VARCHAR(64) NOT NULL", characterSet = "ascii", collation = "ascii_bin" },
        ...
        primaryKey = "id",
        indexes = {
            { name = "idx_agent_phone_company_audit", columns = "(`company_id`, `created_at`, `id`)" },
        },
        foreignKeys = {
            { column = "company_id", references = "`agent_phone_company_profiles` (`company_id`) ON DELETE CASCADE" },
        },
...
Bridge.Database.Migrate("agent_phone", schema)
...
Bridge.Database.Query([[
    UPDATE `agent_phone_sms_messages` message
    INNER JOIN `agent_phone_media` media ON media.`url` = message.`media_payload`
...
Bridge.Database.Query([[
    UPDATE `agent_phone_darkchat_messages` message
    INNER JOIN `agent_phone_media` media ON media.`url` = message.`media_payload`
    SET message.`media_mime` = media.`mime_type`
    WHERE message.`message_type` = 'video'
        AND media.`mime_type` IN ('video/webm', 'video/mp4')
...
Bridge.Database.Query("UPDATE `agent_phone_contacts` SET `contact_id` = `id` WHERE `contact_id` IS NULL", {})
Bridge.Database.EnsureIndex("agent_phone_contacts", "uniq_agent_phone_contacts_account_contact", "(`account_id`, `contact_id`)", { unique = true })
Bridge.Database.EnsureIndex("agent_phone_contacts", "uniq_agent_phone_contacts_device_contact", "(`device_imei`, `contact_id`)", { unique = true })
Bridge.Database.EnsureIndex(
    "agent_phone_media",
    "uniq_agent_phone_media_account_source",
    "(`account_id`, `source_id`, `remote_id`, `origin`)",
    { unique = true }
)
Bridge.Database.EnsureIndex(
    "agent_phone_media",
    "uniq_agent_phone_media_device_source",
    "(`device_imei`, `source_id`, `remote_id`, `origin`)",
    { unique = true }
)
Bridge.Database.CompleteMigration("agent_phone")
