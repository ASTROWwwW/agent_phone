...
let skyRideAvailableRequests = [
  {
    ...
    driver: null,
    durationSeconds: 480,
    id: 'agentride-request-demo',
    passenger: {
      avatarUrl:
        'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=240&q=80',
      id: 'agentride-passenger-jordan',
      name: 'Jordan Lee',
      rating: 4.84,
      trips: 38,
    },
...
const smsMessages = [
  ...
  },
  {
    ...
    media_payload: {
      ...
      kind: 'post',
      link: 'agentphone://picstagram/post/picstagram-post-neon-nights',
      subtitle: '@morgan',
...
const darkChatMessages = [
  ...
  },
  {
    ...
    sharePayload: {
      ...
      kind: 'post',
      link: 'agentphone://feather/post/feather-post-downtown-awake',
      subtitle: '@nightowl',
...
const demoWallpaperUrl = '/img/wallpapers/agent-phone-demo-gradient.png'
const deviceData = {
  appAuth: {
    payload: {
  ...
  games: {
    payload: {
      ...
      'agent-flappy': { design: 'neon', highScore: 23, soundEnabled: true },
  ...
  'flare-match-demo-0000-0000-0000000001': [
    ...
    },
    {
      ...
      sharePayload: {
        ...
        kind: 'playlist',
        link: 'agentphone://music/playlist/music-playlist-friday-jazz',
...
const easyShareCatalog = [
  ...
  },
  {
    ...
    kind: 'document',
    link: 'agentphone://calendar/event/calendar-event-easyshare',
  ...
  },
  {
    ...
    kind: 'link',
    link: 'agentphone://citymarkt/listing/listing-easyshare-comet',
    subtitle: '$84,000',
  ...
  },
  {
    ...
    kind: 'location',
    link: 'agentphone://location/current',
    title: 'Legion Square',
  },
  {
    appId: 'notes',
  ...
  },
  {
    ...
    kind: 'playlist',
    link: 'agentphone://music/playlist/playlist-easyshare-night-drive',
    subtitle: '8 tracks',
  ...
  },
  {
    ...
    kind: 'post',
    link: 'agentphone://local-pages/post/pages-post-easyshare-road-closure',
  ...
  },
  {
    ...
    kind: 'profile',
    link: 'agentphone://picstagram/profile/picstagram-profile-easyshare-mia',
    subtitle: '@mia.santos',
    title: 'Mia Santos',
  },
  {
  ...
  },
  {
    ...
    kind: 'track',
    link: 'agentphone://music/server/night-drive',
    subtitle: 'Neon Coast',
    title: 'Night Drive',
  },
  {
  ...
  },
  {
    ...
    id: 'mechanic',
    kind: 'profile',
    link: 'agentphone://companies/profile/mechanic',
    subtitle: '555-MECH',
  ...
  },
  {
    ...
    id: 17,
    kind: 'document',
    link: 'agentphone://mail/message/17',
  ...
  },
  {
    ...
    kind: 'document',
    link: 'agentphone://house/property/vespucci-apartment-4',
    subtitle: 'Owner',
...
app.post('/api/:endpoint', (request, response) => {
  ...
  if (endpoint === 'agentride:get-player-coords') {
    response.json({
      success: true,
  ...
  if (endpoint === 'agentride:quote') {
    ...
    const options = definitions.map((definition) => {
      ...
      const option = {
        ...
        quoteId: 'agentride-quote-' + Date.now() + '-' + definition.serviceClass,
  ...
  if (endpoint === 'agentride:set-driver-status') {
