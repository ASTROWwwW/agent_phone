...
import appStoreIcon from '@/assets/img/app-icons/apps.svg'
...
import snakeIcon from '@/assets/img/app-icons/snake.svg'
...
import citymarktIcon from '@/assets/img/app-icons/citymarkt.svg'
...
export const PHONE_APPS = shallowReactive<PhoneAppDefinition[]>([
  ...
  },
  {
    category: 'utilities',
    component: markRaw(
      defineAsyncComponent(() => import('@/views/apps/AgentRideApp.vue')),
    ),
    dockOrder: null,
    gridOrder: 25,
  ...
  },
  {
    ...
    gridOrder: 17,
    icon: markRaw(Wind),
    iconClass: 'app-icon--agent-flappy',
    iconImage: agentFlappyIcon,
    id: 'agent-flappy',
