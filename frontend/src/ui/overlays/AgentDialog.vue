...
<template>
  <Transition
    name="agent-dialog-pop"
    :duration="{ enter: 400, leave: 400 }"
    appear
  >
    <div v-if="opened" ref="root" v-bind="$attrs" class="agent-dialog">
      <div
        v-if="backdrop"
      ...
      <component
        :is="component"
        ref="panel"
        class="agent-dialog__panel agent-glass-surface"
        :role="effectiveRole"
        ...
        :tabindex="tabindex"
      >
        <div class="agent-dialog__content">
        ...
        <div v-if="$slots.buttons" class="agent-dialog__buttons">
          <slot name="buttons" />
        </div>
      </component>
    </div>
