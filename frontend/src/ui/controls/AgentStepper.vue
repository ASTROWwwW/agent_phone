...
<template>
  <component
    ...
    class="agent-stepper"
    :class="{
      'agent-stepper--buttons-only': buttonsOnly,
      'agent-stepper--disabled': disabled,
      'agent-stepper--input': input,
      'agent-stepper--large': large,
      'agent-stepper--outline': outline,
      'agent-stepper--raised': raised,
      'agent-stepper--rounded': rounded,
      'agent-stepper--small': small,
    }"
  >
    <button
      class="agent-stepper__button agent-stepper__decrement"
      type="button"
    ...
    <input
      ...
      :id="inputId"
      class="agent-stepper__value agent-stepper__input"
    ...
    <button
      class="agent-stepper__button agent-stepper__increment"
      type="button"
      :aria-controls="input && !buttonsOnly ? inputId : undefined"
