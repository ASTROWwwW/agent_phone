...
const highlightStyle = computed(() => ({
  '--agent-glass-highlight-x': highlightX.value,
  '--agent-glass-highlight-y': highlightY.value,
  '--agent-glass-touch-scale': touchScale.value,
}))
...
<template>
  <component
    ...
    class="agent-glass"
    :class="{
      'agent-glass--disabled': disabled,
      'agent-glass--highlight': highlight,
      'agent-glass--highlight-visible': highlightVisible,
      'agent-glass--interactive': component === 'a' || component === 'button',
      'agent-glass--touch-highlight': touchHighlight,
    }"
