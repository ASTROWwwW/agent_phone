...
describe('ProgressbarDemo', () => {
  ...
  it('keeps every Konsta progress value and color row', () => {
    ...
    expect(source).toContain('class="agent-ui-demo-color-red"')
    expect(source).toContain(':progress="0.25"')
    expect(source).toContain('class="agent-ui-demo-color-green"')
    expect(source).toContain(':progress="0.5"')
    expect(source).toContain('class="agent-ui-demo-color-yellow"')
    expect(source).toContain(':progress="0.75"')
    expect(source).toContain('class="agent-ui-demo-color-purple"')
