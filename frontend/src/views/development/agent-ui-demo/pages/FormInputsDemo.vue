...
import { AgentBlockTitle, AgentField, AgentList } from '@/ui'
...
<template>
  <AgentUiDemoPage title="Form Inputs">
    <AgentBlockTitle>Default</AgentBlockTitle>
    ...
    <AgentBlockTitle>Outline</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-for="field in defaultFields"
        :key="field.key"
    ...
    <AgentBlockTitle>Floating Labels</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
    ...
    <AgentBlockTitle>Outline + Floating Labels</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-for="field in floatingFields"
        :key="field.key"
    ...
    <AgentBlockTitle>Validation + Additional Info</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-model="name"
        :error="nameError"
    ...
    <AgentBlockTitle>Clear Button</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-model="demoValue"
    ...
    <AgentBlockTitle>Icon + Input</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
    ...
    <AgentBlockTitle>Label + Input</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-for="field in shortFields"
        :key="field.key"
    ...
    <AgentBlockTitle>Only Inputs</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
        v-for="field in shortFields"
        :key="field.key"
    ...
    <AgentBlockTitle>Inputs + Additional Info</AgentBlockTitle>
    <AgentList inset strong>
      <AgentField
