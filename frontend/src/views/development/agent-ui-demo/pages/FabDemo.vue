...
import { AgentBlock, AgentFab } from '@/ui'

import AgentUiDemoPage from '../AgentUiDemoPage.vue'
</script>

<template>
  <AgentUiDemoPage title="FAB">
    <AgentBlock class="fab-demo__copy" inset strong>
      <p>
    ...
    <template #fixed>
      <AgentFab
        ...
        class="fab-demo__button fab-demo__button--right-top agent-ui-demo-color-red"
      >
      ...
      <AgentFab
        ...
        class="fab-demo__button fab-demo__button--left-bottom agent-ui-demo-color-green"
      >
        <template #icon><Plus /></template>
      </AgentFab>
      <AgentFab
        aria-label="Add from the top left"
        class="fab-demo__button fab-demo__button--left-top agent-ui-demo-color-yellow"
      >
        <template #icon><Plus /></template>
      </AgentFab>
      <AgentFab
...
.fab-demo__button--right-bottom {
  ...
  bottom: calc(var(--agent-safe-area-bottom) + var(--agent-space-4));
}

.fab-demo__button--right-top {
  top: calc(var(--agent-safe-area-top) + var(--agent-navbar-height) + 16px);
  right: calc(var(--agent-safe-area-right) + var(--agent-space-4));
}
...
.fab-demo__button--center.agent-glass--touch-highlight {
  transform: translate(-50%, -50%) scale(var(--agent-glass-touch-scale, 1.25));
}
...
.fab-demo__button--center-bottom.agent-glass--touch-highlight {
  transform: translateX(-50%) scale(var(--agent-glass-touch-scale, 1.25));
}
