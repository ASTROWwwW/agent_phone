...
<template>
  ...
  >
    <template #navbarRight><AgentLink>Right</AgentLink></template>
    ...
    <AgentBlockTitle>Size</AgentBlockTitle>
    <AgentBlockHeader>
    ...
    <AgentList inset strong>
      ...
      >
        <template #after>
          <AgentRadio v-model="size" name="navbar-size" :value="option" />
        </template>
      </AgentListItem>
    </AgentList>

    <AgentBlockTitle>Transparent</AgentBlockTitle>
    <AgentBlockHeader>
      When navbar is transparent, its title and background will become visible
      on page scroll
    </AgentBlockHeader>
    <AgentList inset strong>
      <AgentListItem title="Transparent">
        <template #after>
          <AgentToggle v-model="isTransparent" aria-label="Transparent navbar" />
        </template>
      </AgentListItem>
    </AgentList>
