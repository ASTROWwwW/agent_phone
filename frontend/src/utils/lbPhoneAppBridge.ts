...
const STORAGE_KEY_PREFIX = 'agent_phone:lb-app-storage:v1:'

export const LB_PHONE_STORAGE_MESSAGE_TYPE = 'agent-phone:lb-storage'
export const LB_PHONE_ACTION_MESSAGE_TYPE = 'agent-phone:lb-action'
...
globalThis.addEventListener('message', (event) => {
  ...
  if (message.type === 'agent-phone:lb-settings') {
