...
const cryptoFallbackLocales = {
  ...
  auth: {
    ...
    login: 'Log in',
    register: 'Register',
    accountEmail: 'Agent Cloud email',
    accountMissing: 'No Agent Cloud account',
...
const adminPanelFallbackLocales = {
  ...
  configurator: {
    ...
    disabledBody:
      'Enable the configurator at the beginning of config.lua and restart agent_phone. Until then, file values remain active and editing is locked.',
...
const defaultLocales: LocaleTree = {
  ...
  Apps: {
    ...
    crewlink: {
      ...
      signInTitle: 'Connect your Agent Cloud account',
      signInBody:
        'CrewLink uses your private Agent Cloud identity to keep groups and roles available across your phones.',
      openSettings: 'Open Agent Cloud settings',
      ...
      authErrors: {
        no_ifruit_account:
          'Sign in to your Agent Cloud account in Settings first.',
    ...
    flare: {
      ...
      signInBody:
        'Flare profiles and matches are linked to your private Agent Cloud account.',
      ...
      signOut: 'Sign Out',
      signOutTitle: 'Sign out of Agent Cloud?',
      signOutBody:
        'This signs the whole phone out of Agent Cloud. Your Flare profile, matches and chats stay stored.',
      signingOut: 'Signing Out...',
      signOutHint:
      ...
      deleteAccountBody:
        'Your Flare profile, swipes, matches and conversations will be permanently deleted. Your Agent Cloud account and Photos library stay available.',
    ...
    picstagram: {
      ...
      errors: {
        ...
        already_registered:
          'This Agent Cloud account already owns a Picstagram profile.',
        ...
        not_authenticated: 'Sign in to Agent Cloud first.',
    ...
    feather: {
      ...
      loginNow: 'Log in',
      authTrust:
        'Your Feather profile is linked to your Agent Cloud account through your iFruit email.',
      profileStep: 'Step 2 of 2',
      accountConnected: 'Agent Cloud account connected',
      authErrors: {
        no_ifruit_account:
          'Sign in to your Agent Cloud account in Settings first.',
      ...
      welcomeBody:
        'Join the live conversation in Los Santos. Your Feather profile stays linked to your Agent Cloud account.',
      ...
      errors: {
        accountRequired: 'Sign in to Agent Cloud in Settings first.',
    ...
    fliptok: {
      ...
      errors: {
        ...
        invalid_credentials: 'Username or password is incorrect.',
        already_registered:
          'This Agent Cloud account already owns a registered FlipTok profile.',
        handle_taken: 'This username is already taken.',
    ...
    darkchat: {
      ...
      signInBody:
        'DarkChat identities are linked to your private Agent Cloud account.',
      ...
      signOutTitle: 'Sign out of Agent Cloud?',
      signOutBody:
        'This signs the whole phone out of Agent Cloud. Your DarkChat profile and messages remain stored.',
      signingOut: 'Signing Out...',
      signOutHint:
        'Signing out affects every app that uses Agent Cloud on this phone.',
    ...
    appStore: {
      ...
      taglines: {
        ...
        agentride: 'City rides and driver booking',
      ...
      account: {
        ...
        agentAccount: 'Agent Phone Account',
        apps: 'Installed Apps',
        games: 'Games',
      ...
      details: {
        ...
        description:
          '{app} is a detailed {category} experience made for Agent Phone. Explore its features, connect with the city and keep everything close at hand.',
        crypto: {
          releaseNotes:
          ...
          description:
            "VaultX is Agent Phone's fictional crypto exchange and wallet. Track synthetic markets, manage your character-bound portfolio, deposit or withdraw funds, trade with short-lived server quotes and transfer assets using public VaultX keys. All prices are fictional and have no real-world value.",
        },
      },
    },
    phone: {
    ...
    agentride: {
      name: 'AgentRide',
      loading: 'Loading AgentRide',
      unavailable: 'AgentRide unavailable',
      tryAgain: 'Try Again',
      mode: {
        rider: 'Ride',
        driver: 'Drive',
      ...
      change: 'Change',
      requestRide: 'Request AgentRide',
      playerDriverNotice:
        'AgentRide matches you with real player drivers. A driver must be online and accept your request.',
      ...
      profileDetails: 'Profile details',
      profileName: 'Name',
      profileNamePlaceholder: 'Your AgentRide name',
      removeProfilePhoto: 'Remove profile photo',
      saveProfile: 'Save Profile',
      profileSaved: 'Your AgentRide profile was updated.',
      memberSince: 'AgentRide member since {date}',
    ...
    citymarkt: {
      ...
      signInTitle: 'Sign in to Agent Cloud',
    ...
    localPages: {
      ...
      signInBody: 'Sign in to Agent Cloud in Settings to publish and save posts.',
      ...
      login: 'Sign in',
      register: 'Register',
      loginTitle: 'Continue with Agent Cloud',
      loginBody:
    ...
    calendar: {
      ...
      signInBody:
        'Sign in to Agent Cloud in Settings to sync appointments and receive reminders.',
    ...
    settings: {
      ...
      agentUiKitchenSink: 'Agent UI Kitchen Sink',
      ...
      removeDeviceBody:
        'Enter your Agent Cloud password to remove this device from the account.',
      signOut: 'Sign Out',
      ...
      keepCloudDataBody:
        'Supported information remains in its app or Agent Cloud account.',
      resetSetupAssistant:
      ...
      factoryResetProgress: 'Erasing Agent Phone',
      factoryResetWarning:
      ...
      passcode: {
        description:
          'A passcode protects the contents of this phone. It stays with the device when the SIM or Agent Cloud account changes.',
        status: 'Passcode',
      ...
      back: 'Settings',
      wallpaperPicker: 'Agent Wallpapers',
  ...
  Setup: {
    title: 'Agent Phone Setup Assistant',
    ownerFallback: 'Agent Phone Owner',
    getStarted: 'Get Started',
    setUpLater: 'Set Up Later',
    development: { skip: 'Skip setup' },
    welcome: {
      title: 'Welcome to Agent Phone',
    ...
    connection: {
      ...
      body: 'Agent Phone automatically detects the SIM installed in this device.',
      noSim: 'No SIM installed',
      ready: 'Connected to the Agent network',
    ...
    cloud: {
      ...
      body: 'Sign in to sync supported app data and recover it on another Agent Phone.',
      signIn: 'Sign In',
      create: 'Create Account',
      signInTitle: 'Sign in to Agent Cloud',
      createTitle: 'Create your Agent Cloud account',
      signInBody:
      ...
      accountPreview: 'Your Agent Cloud ID',
      accountName: 'Account name',
      addressPlaceholder: 'alex.morgan',
      email: 'Agent Cloud Email',
      password: 'Password',
      confirmPassword: 'Confirm Password',
      ...
      createAction: 'Create Agent Cloud Account',
      securityNote: 'Encrypted connection · Your password stays private',
      connected: 'Agent Cloud connected',
      invalid: 'Enter a valid email and a password with at least 6 characters.',
      errors: {
        invalid_email: 'Enter a valid Agent Cloud email.',
        invalid_password: 'Your password must contain at least 6 characters.',
        invalid_credentials: 'Email or password is incorrect.',
        email_taken: 'This Agent Cloud email is already registered.',
        rate_limited: 'Too many attempts. Try again shortly.',
        request_failed: 'Agent Cloud is temporarily unavailable.',
      },
    },
    security: {
    ...
    wallpaper: {
      eyebrow: 'Personalize',
      title: 'Make it yours',
      body: 'Choose one of twelve crafted Agent Phone backgrounds.',
    },
    notifications: {
    ...
    ready: {
      ...
      title: 'Welcome, {name}',
      body: 'Your Agent Phone is configured and ready. Your choices can always be refined in Settings.',
      localOnly: 'Stored on this phone',
      enter: 'Enter Agent Phone',
      review: 'Review Setup',
