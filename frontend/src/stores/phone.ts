...
const defaultLocales: LocaleTree = {
  ...
  Apps: {
    ...
    banking: {
      ...
      noResults: 'No transaction matches this search.',
      filters: {
        all: 'All',
        income: 'Income',
        expenses: 'Expenses',
    ...
    citymarkt: {
      ...
      signInBody: 'Log in to your CityMarket profile to sell, save or message.',
      authEyebrow: 'CityMarket account',
      ...
      authRegisterBody:
        'Confirm your linked iFruit account to create a CityMarket profile.',
      login: 'Sign in',
      ...
      authErrors: {
        ...
        profile_exists:
          'A CityMarket profile already exists. Use Sign in instead.',
        rate_limited: 'Too many attempts. Try again in a minute.',
      ...
      createProfile: 'Create your CityMarket profile',
      editProfile: 'Edit profile',
      ...
      errors: {
        ...
        request_failed: 'CityMarket is temporarily unavailable.',
